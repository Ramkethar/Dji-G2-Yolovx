...
def main():
    ...
    while not sources:
        ...
        ndi.find_wait_for_sources(ndi_find, 500)  # Reduce wait time to 500 ms
    ...
    # Load YOLOv8 model
    yolo_model = YOLO(r'C:\Users\91902\Documents\dji g2\yolov8s_drone2\yolov8s_drone2\weights\best.pt')

    cv.startWindowThread()

    while True:
        # Receive NDI video frame
        t, v, _, _ = ndi.recv_capture_v2(ndi_recv, 500)  # Reduce wait time to 500 ms
        ...
        if t == ndi.FRAME_TYPE_VIDEO:
            ...
            if isinstance(results, list) and results:
                ...
                cv.imshow('YOLOv8 Tracking with NDI Stream', annotated_frame)
